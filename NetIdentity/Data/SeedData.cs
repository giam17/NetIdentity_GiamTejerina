        ...
        public static async Task Initialize(IServiceProvider serviceProvider)
        {
            ...
            if (await userManager.FindByEmailAsync("admin@test.com") == null)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    await userManager.AddClaimAsync(adminUser, new Claim("EsFemenino", adminUser.EsFemenino.ToString().ToLower())); // "false"
                }
            }
            ...
            if (await userManager.FindByEmailAsync("menor@test.com") == null)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    await userManager.AddClaimAsync(userMenor, new Claim("EsFemenino", userMenor.EsFemenino.ToString().ToLower())); // "false"
                }
            }
            ...
            if (await userManager.FindByEmailAsync("mayor@test.com") == null)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    await userManager.AddClaimAsync(userMayor, new Claim("EsFemenino", userMayor.EsFemenino.ToString().ToLower()));
                }
            }
        }
    }
