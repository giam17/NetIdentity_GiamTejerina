...
builder.Services.AddAuthorization(options =>
{
    ...
    options.AddPolicy("SoloFemeninoBool",
        policy => policy.RequireClaim("EsFemenino", "true"));

    options.AddPolicy("SoloMasculinoBool",
        policy => policy.RequireClaim("EsFemenino", "false"));
});
